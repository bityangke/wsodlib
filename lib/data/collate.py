...
def pad_norm_and_collate(
    ...
    for element, _ in elements:
        ...
        image_labels.append(T.functional.to_tensor(element.image_labels))
        original_sizes.append(T.functional.to_tensor(element.original_size))
        image_sizes.append(T.functional.to_tensor(element.image_size))
        proposals.append(T.functional.to_tensor(element.proposals))
        objectness.append(T.functional.to_tensor(element.objectness))
